...
/*   Updated: 2024/07/08 20:11:50 by vkhrabro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void move_player(t_data *data)
{
    ...
    {
        data->moves.new_x += data->moves.move_speed * data->moves.cos_angle;
        data->moves.new_y += data->moves.move_speed * data->moves.sin_angle;
    }
